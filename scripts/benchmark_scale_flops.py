...
plt.title('Вычислительная сложность (FLOPs)')
plt.legend()
plt.grid(True)
plt.yscale('log')
os.makedirs('plots', exist_ok=True)
plt.savefig('plots/flops_vs_seqlen_compare.png', dpi=150)
plt.show()
...
# Сравнение снижения FLOPs относительно multihead
print("\nСнижение FLOPs относительно MultiHead (%):")
print(f"{'seq_len':>8} ", end="")
